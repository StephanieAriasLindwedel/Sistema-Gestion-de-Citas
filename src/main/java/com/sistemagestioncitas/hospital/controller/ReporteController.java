...
public class ReporteController {
        ...
        public String filtrarCitas(@RequestParam(required = false) String fechaInicio,
                ...
                List<Cita> citasFiltradas = citaService.filtrarCitas(inicio, fin, medicoId, especialidad, estado);
                ...
                Map<String, Long> resumenPorEspecialidad = citasFiltradas.stream()
                                ...
                                .collect(Collectors.groupingBy(c -> c.getMedico().getEspecialidad(),
                                                Collectors.counting()));
                cargarDatosFiltros(model);
        ...
        public ResponseEntity<byte[]> exportarCitasCSV(@RequestParam(required = false) String fechaInicio,
                ...
                List<Cita> citasFiltradas = citaService.filtrarCitas(
                                inicio,
                                fin,
        ...
        private void cargarDatosFiltros(Model model) {
                ...
                model.addAttribute("estados",
                                List.of("PENDIENTE", "CONFIRMADA", "CANCELADA", "AUSENTE", "PRESENTE", "COMPLETADA"));
        }
}
